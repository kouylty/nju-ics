...
instr_func opcode_entry[256] = {
    ...
    /* 0x8c - 0x8f*/ mov_s2rm_w, lea_rm2r_v, mov_rm2s_w, pop_rm_v,
    ...
    /* 0xe4 - 0xe7*/ in_i2a_b, in_i2a_v, inv, inv,
    /* 0xe8 - 0xeb*/ call_near, jmp_near, jmp_far, jmp_short,
    /* 0xec - 0xef*/ in_b, in_v, out_b, out_v,
    /* 0xf0 - 0xf3*/ inv, break_point, inv, rep_repe,
    /* 0xf4 - 0xf7*/ hlt, cmc, group_3_b, group_3_v,
    /* 0xf8 - 0xfb*/ clc, stc, cli, sti,
    /* 0xfc - 0xff*/ cld, inv, group_4_b, group_5_indirect,
};
...
/* 0xfe */    
instr_func group_4_b_entry[8] =
    {inc_rm_b, dec_rm_b, inv, inv, inv, inv, inv, inv};

/* 0xff */
instr_func group_5_indirect_entry[8] =
    {inc_rm_v, dec_rm_v, call_near_indirect, inv, jmp_near_indirect, call_far_indirect, push_rm_v, inv};
